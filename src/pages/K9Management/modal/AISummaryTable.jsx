...
export default function AISummaryTable({ aiSummaryModalVisible, setAiSummaryModalVisible, aiSummaryData, aiSummaryLoading, getAISummaryColumns, setSelectedAISummary, setAISummaryDetailModalVisible }) {
  return (
    <Modal
      title="AI Summary"
