...
const AISummaryDetailModal = ({
  aiSummaryDetailModalVisible,
  ...
  return (
    <Modal
      ...
      open={aiSummaryDetailModalVisible}
      onCancel={() => setAISummaryDetailModalVisible(false)}
      footer={[
        <Button key="close" onClick={() => setAISummaryDetailModalVisible(false)}>
          Đóng
        </Button>
      ]}
      width={800}
...
export default AISummaryDetailModal; 