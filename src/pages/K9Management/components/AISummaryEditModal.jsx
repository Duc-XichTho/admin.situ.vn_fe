...
const AISummaryEditModal = ({
  aiSummaryEditModalVisible,
  setAISummaryEditModalVisible,
  selectedAISummary,
  aiSummaryEditForm,
  tables,
  setTables,
  handleUpdateAISummary,
  handleAddTable,
  handleEditTable,
  handleDeleteTable
}) => {
  ...
  return (
    <Modal
      ...
      open={aiSummaryEditModalVisible}
...
export default AISummaryEditModal; 