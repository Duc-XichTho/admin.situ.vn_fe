  ...
  const renderEmptyState = () => {
    return (
      <div className={styles.emptyStateContainer}>
        ...
        {/* Render modals - Cần thiết để có thể mở Settings và Add Case */}
        <SettingsModal
          isMobile={isMobile}
      ...
      {isMobile ? (
        ...
        <div className={styles.newsPanel}>
          ...
          {loading ? (
            ...
            caseUser.map(item => (
              <div key={item.id} className={styles.caseItemWrapper}>
                <NewsItem
                  item={(item)}
                  ...
                  isCase={true}
                />
                {/* Quiz completion status indicator */}
        ...
        // Desktop view: Dual panel with grid sidebar
