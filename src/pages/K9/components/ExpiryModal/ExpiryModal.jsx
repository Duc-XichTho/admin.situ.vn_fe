	...
	const getModalContent = () => {
		if (expiryModalType === 'no_setup') {
			...
			return {
				...
				description: `Tài khoản của bạn sẽ được kích hoạt vào ngày ${startDate ? startDate.toLocaleDateString('vi-VN') : 'N/A'}. Còn ${daysUntilStart} ngày nữa bạn có thể bắt đầu sử dụng hệ thống.`,
				alertType: 'info',
			...
			<div className={styles.modalContent}>
				...
				<div className={styles.modalFooter}>
					<div className={styles.footerActions}>
						{/* Nút Đăng ký/Gia hạn - hiển thị cho expired và no_setup */}
						{(expiryModalType === 'expired' || expiryModalType === 'no_setup') && (
							<Button
								type='primary'
							...
							>
								{expiryModalType === 'expired' ? 'Gia hạn ngay' : 'Đăng ký gói'}
							</Button>
						)}
						<Button
							type='default'
