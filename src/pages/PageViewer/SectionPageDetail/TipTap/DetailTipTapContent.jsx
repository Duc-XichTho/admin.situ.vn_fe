...
export default function DetailTipTapContent() {
	const { editor } = useEditor();
	const [currentUser, setCurrentUser , checkAdminPage , checkEditorPage] = useState(null);
	...
	const handleBack = () => {
		navigate(`/${page}/section/${sectionPageID}`)
	}
