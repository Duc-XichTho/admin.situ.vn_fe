...
import { MuteIcon, TipTap_Icon } from '../../../../icon/IconSvg.jsx';
import { getCurrentUserLogin } from '../../../../apis/userService.jsx';
import { updateContentPage } from '../../../../apis/contentPageService.jsx';

export default function TipTapContent({ sectionPageData }) {
	...
	const fetchData = async () => {
		setFileNotePad(sectionPageData?.contentPage[0]);
	};
	...
	return (
		<div className={css.main}>
			...
			<div className={`${css.content} ${css.customScrollbar}`}>
